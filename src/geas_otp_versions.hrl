...
get_erlang_version("8.0") -> {"24.0-rc1", "24.0-rc2", "24.0-rc2"};
get_erlang_version("7.6.7") -> {"23.3", "23.3.1", "23.3.1"};
get_erlang_version("7.6.6") -> {"23.2", "23.2.7.1", "23.2.7.1"};
...
get_erlang_version("7.5.4.3") -> {"22.3.4.14", "22.3.4.16", "22.3.4.16"};
...
get_erlang_version("7.3.2") -> {"21.3", "21.3.8.22", "21.3.8.22"};
